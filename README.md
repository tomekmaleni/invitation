...
- **`kristina-and-antonio.html`** — *Kristina & Antonio.* Starts as a wax-sealed envelope — a
  photographed close-up of the flap with the K&A wax seal — resting on a wooden desk; drag it and
  it gives way to the open envelope. The invitation then sits inside a real (photographed) open
